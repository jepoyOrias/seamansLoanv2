<template>
    <div v-if="props.toast" class="max-w-xs bg-white border border-gray-200 rounded-xl shadow-lg dark:bg-gray-800 dark:border-gray-700 fixed  bottom-[20px] end-[30px]"
        role="alert">
        <div class="flex p-4">
