<template>
    <div class="overflow-hidden">
        ...
        loan.term_months
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                            ...
                            @click="openModal(loan)"
                                class="cursor-pointer inline-flex items-start gap-x-1.5 py-1.5 px-3 rounded-full text-xs  bg-slate-100 dark:bg-yellow-500/70 dark:text-white text-yellow-600 font-black font-bold">
                                 <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-user-plus shrink-0 size-4"><path d="M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="8.5" cy="7" r="4"/><line x1="20" y1="8" x2="20" y2="14"/><line x1="23" y1="11" x2="17" y2="11"/></svg>
                            </a>
                        </td>
                    </tr>
                </tbody>
        ...
        <ReleasingModal v-model:isOpen="isOpen" v-model:loan="loan"/>
    </div>
...
import ReleasingModal from './ReleasingModal.vue'
