...
class LoanInformationStoreRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'personal_information.TIN_NO' => 'nullable|string|max:255|unique:personal_information',
            'personal_information.SSS_NO' => 'required|string|max:255|unique:personal_information',
            'personal_information.PAGIBIG_NO' => 'required|string|max:255|unique:personal_information',
            ...
            'coborrowers.*.TIN_NO' => 'nullable|string|max:255|unique:coborrowers',
            'coborrowers.*.SSS_NO' => 'required|string|max:255|unique:coborrowers',
            'coborrowers.*.PAGIBIG_NO' => 'required|string|max:255|unique:coborrowers',
